...
export default function SettingsModalRanked({ searchDepth, setSearchDepth, maxDepth, setMaxDepth, evalCap, setEvalCap, setOpenSettings }) {
    ...
    return (
        <Modal className="settings-wrapper">
            <div className="text-center"><h2> Change AI Engine Settings</h2></div>
            <div className="info">
