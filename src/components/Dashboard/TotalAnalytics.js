...
function fetchCurrentTotalStats(user, setTotalMatches, setTotalWins, setTotalLosses) {
    ...
    const userDocRef = doc(userCollectionRef, user.email);
    const userDataRef = collection(userDocRef, `${currentYear}-${currentMonth}`);
    const dayDataRef = doc(userDataRef, `${currentMonth}`);
...
export default function TotalAnalytics() {
    ...
    const setLineChartOptions = {
        options: {
            ...
            xaxis: {
                categories: dailyMatches.map((_, index) => index + 1),
                style: {
                    color: 'white', // set the color of the y-axis title
                    fontWeight: 600, // or any other valid CSS font weight value
                }
                                    ...
                                    <div class="text-right mt-3 mb-3 d-fixed">
                                        <div class="dropdownList">
                                            <MDBDropdown>
                                                ...
                                                <MDBDropdownMenu>
                                                    <MDBDropdownItem link href='/analytics'>Current Stats </MDBDropdownItem>
                                                </MDBDropdownMenu>
                                            </MDBDropdown>
                                        </div>
                                    </div>
                                    <h3><center>Total Stats</center></h3>
                                    <div class="main">
                                        <div class="row sparkboxes mt-4">
                                            <div class="col-md-3">
                                                <div class="box box1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="bar-chart-layout">
                                                    <div class="card shadow-sm-line" style={{ backgroundColor: '#2B2D3E' }}>
                                                        <div class="card-body">
                                                            <div class="chart-widget p-3">
                                                                <ReactApexChart
                                            ...
                                            <div class="col-md-6">
                                                <div class="line-chart-layout">
                                                    <div class="card shadow-sm" style={{ backgroundColor: '#2B2D3E', overflow: 'hidden', width: '1000px' }}>
                                                        <div class="card-body">
                                                            <div class="chart-widget p-6">
                                                                <ReactApexChart
                                                                    options={setLineChartOptions.options}
                                                                    series={setLineChartOptions.series}
                                                                    type="area"
                                                                    height={300}
                                                                />
                                                            </div>
